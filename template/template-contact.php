...
<section>
    <div class="container-xxl py-5 mb-5">
        <div class="row gy-5 align-items-center">
            ...
            <div class="col-md-6">
                <div class="position-relative bg-light p-2 p-lg-4">
                    <form class="row mt-4 position-relative"
                        data-action="<?php echo get_template_directory_uri()?>/inc/src/pear-email.php" id="contact_form"
                        action="#" method="post">
                        <!-- Name -->
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4 form-control-bg-light">
                                <label id="Phone" class="form-label"> <?php echo "Number Phone "; ?> <span
                                        class="fs-sm">(Optional)</span>
                                </label>
                        ...
                        <div class="mb-4 form-control-bg-light">
                            <label class="form-label">
                                <?php echo "Questions and Comments"; ?>
                            </label>
                        ...
                        <!-- Button -->
                        <div>
                            <button class="btn btn-lg loandig btn-primary rounded-0 px-5 text-white text-uppercase mb-0"
                                type="submit">
