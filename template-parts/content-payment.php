...
<section class="container-xl">
    ...
    <div class="content_payment py-4">
        <?php 
...
<section class="container-xl py-4">
    <div class="nav-payment tabs d-flex">
        <li class="tab js-active list-unstyled" data-tab-target="#side-tab498">
            <span class="btn btn-primary text-light me-3">
                PAY WITH ANY CARD
            </span>
        </li>
        <li class="tab list-unstyled" data-tab-target="#side-tab218">
            <span class="btn btn-primary text-light">
                PAY WITH WETRAVEL
            </span>
        </li>
    </div>
